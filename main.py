...
if getattr(sys, 'frozen', False):
    ...
    EXE_DIR = os.path.dirname(sys.executable)   # folder where EXE lives (has config.py)
    SCRIPT_DIR = sys._MEIPASS                    # folder where bundled .py modules live
    # MEIPASS must come first so bundled modules are found before anything else
